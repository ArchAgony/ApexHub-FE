          ...
          <thead>
            <tr class="border-b border-gray-200 dark:border-gray-700">
              ...
              <th class="px-5 py-3 text-left w-2/11 sm:px-6">
                <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Car model</p>
              </th>
              <th class="px-5 py-3 text-left w-2/11 sm:px-6">
                <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Part name</p>
              </th>
              <th class="px-5 py-3 text-left w-2/11 sm:px-6">
                <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Mileage (km)</p>
              </th>
              <th class="px-5 py-3 text-left w-2/11 sm:px-6">
            ...
            class="border-b hover:bg-gray-50">
              ...
              <td class="px-5 py-3 text-left w-3/11 sm:px-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <router-link :to="`/components/${component.id}/edit`">
                      <button
