...
const fetchData = async () => {
  try {
    ...
    const [carsResponse, componentResponse] = await Promise.all([
      apiClient.get('/cars'),
    ...
    const data = componentResponse.data.data

    form.car_id = data.car_id
    form.part_name = data.part_name
    form.mileage_km = data.mileage_km
...
const handleUpdate = async () => {
  ...
  try {
    await apiClient.put(`/components/${componentId}`, form)
